...
const DealerSignup = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            if (!otpSent) {
                ...
                if (res.data.token) {
                    toast.success("Signup successful! You've successfully signed up as a Dealer.", { autoClose: 3000 });
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-white px-4">
            <div className="w-full max-w-lg m-3 bg-white rounded-3xl shadow-xl px-6 py-10 space-y-6 border border-gray-100">
                    ...
                    {[
                        ...
                        <div key={name} className="relative">
                            <input
                                ...
                                className="w-full py-3 pl-4 pr-10 rounded-xl border border-gray-300 focus:ring-2 focus:ring-blue-500 outline-none text-sm"
                            />
                        ...
                        <div className="bg-white rounded-2xl p-6 w-full max-w-sm space-y-6 shadow-xl">
                            ...
                            <div className="text-center space-y-1">
                                ...
                                <p className="text-sm text-gray-600">
                                    ...
                                    <span className="text-blue-600 font-semibold">+91 {formData.phone}</span>
                                </p>
                            </div>
                            ...
                            <div className="text-center text-sm text-gray-600">
                                {canResendOtp ? (
                                    ...
                                    <>
                                        Request new OTP in:{" "}
                                        <span className="text-blue-600 font-semibold">{formatTimer()}</span>
                                    </>
                                )}
                            </div>
                ...
                {showSuccessScreen && (
                    <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 px-4">
                        <div className="relative bg-white rounded-xl p-6 w-full max-w-xs text-center space-y-3 shadow-lg">
                            ...
                            {/* blue Check Icon - Positioned at the top center */}
                            ...
                            <div className="mt-10">
                                <h3 className="text-blue-600 font-semibold text-lg">OTP Verified successfully</h3>
                ...
                <p className="text-sm text-center text-gray-700 mt-6 leading-relaxed">
                    ⚠️ <strong>You can continue here</strong>, but for the <strong>full experience</strong>, we highly recommend using our mobile app.
                    <br />
                    📱 <span className="text-blue-600 font-semibold">You may proceed using the website or switch to the mobile app anytime.</span>
                </p>

                <div className="mt-4 flex flex-col items-center gap-4">
                    <a href="/download-section"
                        className="inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-700 text-white font-medium px-6 py-3 rounded-full shadow-md transition-all duration-200 transform hover:scale-105"
                    >
