...
import { Home, Settings, LogOut, Text, LayoutDashboard, Grid2x2Check, HistoryIcon, PackageCheck, PackagePlus, RecycleIcon, BellIcon, BellRingIcon, BellRing, GitPullRequest, ConciergeBell, ClipboardPenLine, History, ContactRound } from "lucide-react";
...
const Sidebar = () => {
    ...
    const navItems = [
...

        {
            name: "Notifications", path: "/notifications", icon:
                unreadCount > 0 ? (
                    <BellRing size={20} className="text-red-500 animate-pulse" />
                ) : (
                    <BellIcon size={20} />
                ),
    ...
    return (
        <aside className="w-64 bg-white shadow-lg p-5 hidden md:flex flex-col justify-between min-h-screen">
            <div>
                {/* Logo + Name */}
