  ...
  const handleSubmit = async (e) => {
    ...
    try {
      if (!otpSent) {
        ...
        const res = await axios.post(`${import.meta.env.VITE_BACK_URL}/auth/volunteer`, payload);

        if (res.data.token) {
          toast.success("Signup successful! You've successfully signed up as a volunteer.", { autoClose: 3000 });
