        ...
        <div className="m-6 overflow-hidden">
            <div className="flex flex-col lg:flex-row gap-4 sm:gap-8 bg-[#F6F6F6] rounded-[1.125rem]">
                ...
                <div className="w-full lg:w-1/2 p-4 md:p-8">
                    <h1 className="text-[1.75rem] text-[#579B52] font-semibold">Watch How Gauabhayaranyam Works</h1>
                    <p className="text-[#151515] text-[1.10rem] md:text-[1.25rem] font-medium py-3">
                        From doorstep pickup to community impact, see how your scrap donation creates change.
                        Our short video takes you through the journey.</p>
