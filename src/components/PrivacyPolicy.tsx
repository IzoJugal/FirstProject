      ...
      <div className="w-full max-w-3xl bg-white shadow-2xl rounded-2xl p-8 space-y-6">
        ...
        <div className="prose prose-sm max-w-none text-gray-700 space-y-4">
          ...
          <section>
            ...
            <p>
              Welcome to the Gaudaan Donation Platform. We are committed to
          ...
          <section>
            ...
            <p>
              We collect the following personal information when you submit a
              Gaudaan donation form:
            </p>
            <ul className="list-disc pl-5">
              <li>
                <strong>Personal Details</strong>: Name, email address, phone
                number, and government ID (optional).
              </li>
              <li>
                <strong>Location Information</strong>: Pickup address and
                geographic coordinates (latitude and longitude).
              </li>
              <li>
                <strong>Animal Information</strong>: Animal registered ID,
                animal type, condition, and description.
              </li>
              <li>
                <strong>Images</strong>: Up to five images of the animal or
                related documentation.
              </li>
              <li>
                <strong>Consent</strong>: Explicit consent for data processing.
              </li>
            </ul>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5">
              ...
              <li>
                To verify your identity and ensure compliance with animal
                welfare regulations.
              </li>
              <li>
                To communicate with you regarding your donation status or
                updates.
              </li>
              <li>
          ...
          <section>
            ...
            <p>
              Your data is stored securely in our MongoDB database, hosted on
              servers compliant with Indian data localization requirements. We
              implement industry-standard security measures, including:
            </p>
            <ul className="list-disc pl-5">
              <li>
                Encryption of sensitive information (e.g., government ID, email,
                phone).
              </li>
              <li>
            ...
            <p>
              Images uploaded are stored securely, and access is restricted to
              authorized volunteers and administrators.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc pl-5">
              <li>
                Volunteers assigned to your donation for pickup coordination.
              </li>
              <li>Shelters or organizations receiving the donated animal.</li>
              <li>
                Regulatory authorities, if required by law (e.g., for animal
                welfare compliance).
              </li>
            </ul>
            <p>
              We do not sell or share your data for marketing purposes without
          ...
          <section>
            ...
            <p>
              ...
              <a
                href="mailto:support@gaudaan.com"
          ...
          <section>
            ...
            <p>
              ...
              Typically, donation data is retained for 5 years to comply with
              animal welfare and tax regulations.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              Our platform may use cookies to enhance user experience and track
              usage analytics. You can manage cookie preferences through your
              browser settings.
            </p>
          </section>
          ...
          <section>
            ...
            <p>
              ...
              be posted on this page with the updated date below. We encourage
