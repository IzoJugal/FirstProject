...
const DealerSignup: React.FC = () => {
  ...
  const handleOtpSubmit = async (e: React.MouseEvent<HTMLButtonElement>) => {
    ...
    try {
      ...
      if (res.data.token) {
        toast.success("Signup successful! You've successfully signed up as a Dealer.", {
          autoClose: 3000,
        });
    ...
    <div className="min-h-screen flex items-center justify-center bg-white px-4">
      <div className="w-full max-w-lg m-3 bg-white rounded-3xl shadow-xl px-6 py-10 space-y-6 border border-gray-100">
        ...
        {showSuccessScreen && (
          <div className="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50 px-4">
            <div className="relative bg-white rounded-xl p-6 w-full max-w-xs text-center space-y-3 shadow-lg">
              {/* Success Check Icon - Positioned at the top center */}
        ...
        <p className="text-sm text-center text-gray-700 mt-6 leading-relaxed">
          ⚠️ <strong>You can continue here</strong>, but for the <strong>full experience</strong>, we
          highly recommend using our mobile app.
          <br />
          📱{" "}
